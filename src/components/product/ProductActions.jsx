    ...
    return (
        <div className={styles["product-action"]}>
            <Grid container spacing={3} >
                <Grid item xs={7}>
                    <Button variant="contained" color="success" onClick={onBid} disabled={!isLive}   style={{backgroundColor:'rgba(12, 12, 20, 0.5)' }} className={classNames(styles.button)}>Buy for {buyAmount}</Button>
                </Grid>
                <Grid item xs={5} >
